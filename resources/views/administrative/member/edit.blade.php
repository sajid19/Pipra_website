...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0"> Member Edit</h4>
    </div>
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card offset-md-2">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Member Edit</h6>
                <form class="forms-sample" action="{{route('administrative.member.update',$data->id)}} " method="POST" enctype="multipart/form-data">
                    @csrf
                    {!! method_field('PUT') !!}
                    <div class="form-group {{ $errors->has('serial') ? 'has-danger' : '' }}">
                        <label for="serial">Serial</label>
                        <input value="{{$data->serial}}" required type="number" class="form-control form-control-danger" id="serial" name="serial" autocomplete="off" placeholder="Serial" aria-invalid="true">
